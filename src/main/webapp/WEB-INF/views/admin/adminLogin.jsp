...
<!-- iCheck -->
<link rel="stylesheet" href="${ctxpath}/resources/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<form action="<c:url value='/admin/aloginPost'/>" method="post" name="form1" onsubmit="return checkAdmin">
				<div class="form-group has-feedback">
					<input type="text" class="form-control" name="adminid" placeholder="USER ID">
	...
	<!-- jQuery 3 -->
	<script src="${ctxpath}/resources/plugins/jquery/jquery-3.2.1.min.js"></script>
	<!-- Bootstrap 3.3.7 -->
